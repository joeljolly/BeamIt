...
public class mapActivity extends FragmentActivity implements OnMapReadyCallback {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Toast.makeText(mapActivity.this, "Bundle 888 successful", Toast.LENGTH_LONG).show();
        try {
        ...
        {
            Toast.makeText(mapActivity.this, "Set Content not successful", Toast.LENGTH_LONG).show();
        }
    }
 ...
 /**
    ...
    public String getAddress(LatLng point)
    {
        ...
        {
            Toast.makeText(mapActivity.this,"GPS not enabled!",Toast.LENGTH_LONG);
        }
